				...
				<div class="col-md-8 col-lg-9" id="post-list-default">
					...
					<li class="list-group-item" id="mc-page-<?php echo $val['id']; ?>">
						<div class="media">
							...
							<a class="pull-left" href="<?php echo mc_get_url($user_id); ?>">
								<img width="40" class="media-object" src="<?php echo mc_user_avatar($user_id); ?>" alt="<?php echo mc_user_display_name($user_id); ?>">
							</a>
							<div class="media-body">
								...
								<?php elseif($key=='publish') : ?>
									...
									<?php else : ?>
									<p><?php echo mc_cut_str(strip_tags(mc_get_page_field($page_id,'content')), 250); ?></p>
									<?php endif; ?>
								<?php elseif($key=='perform') : ?>
								...
								<?php endif; ?>
								<p class="post-info">
									<i class="glyphicon glyphicon-time"></i><?php echo mdate('Y-m-d H:i:s',$val['date']); ?>
								</p>
							</div>
						</div>
					</li>
				...
				<div class="col-md-4 col-lg-3 hidden-xs hidden-sm home-side">
					...
					<div class="panel panel-default">
						...
						<ul class="list-group">
							...
							<li class="list-group-item">
								<div class="media">
									<a class="pull-left img-div" href="<?php echo mc_get_url($val['id']); ?>">
					...
					<div class="panel panel-default">
						...
						<?php 
							...
							$newbaobei = M('page')->where($condition)->order('id desc')->limit(0,2)->select();
							if($newbaobei) :
						?>
						<ul class="list-group">
							...
							<li class="list-group-item">
								<div class="media">
									...
									<div class="media-body">
										...
										<p><span><?php echo mc_get_meta($val['id'],'price'); ?></span> <small>元</small></p>
										<a href="<?php echo mc_get_meta($val['id'],'link'); ?>" class="btn btn-warning btn-xs">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="icon-th-list"></i> 最新话题
							<a class="pull-right" href="<?php echo U('publish/index/add_post'); ?>"><i class="icon-plus"></i></a>
						</div>
						<?php 
