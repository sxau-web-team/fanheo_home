					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-5 col-lg-3 text-right">
							<?php 
								...
								elseif($type=='group') :
								$type_name = '<span class="btn btn-sm btn-warning">群组</span>';
								elseif($type=='baobei') :
								$type_name = '<span class="btn btn-sm btn-warning">宝贝</span>';
								elseif($type=='baobei_pending') :
								$type_name = '<span class="btn btn-sm btn-danger">宝贝-待审核</span>';
								elseif($type=='article') :
								$type_name = '<span class="btn btn-sm btn-warning">文章</span>';
								else :
								$type_name = '<span class="btn btn-sm btn-warning">主题</span>';
								endif;
								echo $type_name;
							?>
						</div>
