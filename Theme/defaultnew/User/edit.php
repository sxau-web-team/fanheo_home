			...
			<div class="col-lg-12">
				...
				<form role="form" method="post" action="<?php echo mc_page_url(); ?>">
				    ...
				    <div class="form-group">
				        ...
				        <input name="buyer_name" type="text" class="form-control" value="<?php echo mc_get_meta(mc_user_id(),'buyer_name',true,'user'); ?>" placeholder="订餐人姓名">
				    </div>
				    <div class="form-group">
				    	<div class="row">
				    		<div class="col-sm-6">
				    			<input name="buyer_province" type="text" class="form-control" value="山西农业大学" placeholder="学校" disabled>
				    			<p class="help-block">
						           暂只支持山西农业大学内部及周边订餐
						        </p>
				    		</div>
				    ...
				    <div class="form-group">
				        <textarea name="buyer_address" class="form-control" rows="3" placeholder="作为饭盒粉，你在哪个角落呢？"><?php echo mc_get_meta(mc_user_id(),'buyer_address',true,'user'); ?></textarea>
				    </div>
				    <div class="form-group">
				        <input name="buyer_phone" type="text" class="form-control" value="<?php echo mc_get_meta(mc_user_id(),'buyer_phone',true,'user'); ?>" placeholder="联系电话，非常重要哦">
				    </div>
