...
<body class="page-header-fixed">
	...
	<?php mc_template_part('Admin_sidebar'); ?>
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							店铺列表 <small>今日任务：统计在售商户商品的库存</small>
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo mc_page_url();?>">店铺管理</a>

								<i class="icon-angle-right"></i>

							</li>

							<li><a href="<?php echo mc_page_url();?>">店铺列表</a></li>
							...
							<li style="float:right;padding-right:20px;"><a href="#" class="" data-toggle="modal" data-target="#addtermModal">添加店铺</a></li>
		...
		<script type="text/javascript">
			...
			document.getElementById('brandlist').className = 'active '; 
