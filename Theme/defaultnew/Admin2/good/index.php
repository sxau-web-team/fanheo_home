...
<table class="table table-hover">
				...
				<?php foreach($page as $val) : ?>
						...
						<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='#FFF5EE';">
							...
							<td><?php echo mc_get_page_field(mc_get_meta($val['id'],'local'),'title'); ?>-<?php echo mc_get_page_field(mc_get_meta($val['id'],'store'),'title'); ?><?php echo mc_get_meta($val['id'],'local');?></td>
