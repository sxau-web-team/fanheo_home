...
<div id="home-download" class="text-center pr" style="background-image: url(http://mao10.b0.upaiyun.com/20140728/20140728095015_77082.jpg); background-position: center top; background-repeat: no-repeat; background-attachment: fixed; width: 100%; margin:-20px 0 20px; padding:150px 0;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
		<div style="position: relative; z-index:10;">
		<h1 style="color:#fff;margin-bottom:20px;">Mao10CMS V2.4下载</h1>
		<p style="color:#fff;margin:0 auto 30px; font-size:18px; max-width:720px;">Mao10CMS是基于Thinkphp和Bootstrap开发的免费开源PHP建站系统，适用于搭建各种小型商城、购物分享、社区以及企业网站。当然，您也可以用它来做一个简单的博客。</p>
		<a class="btn btn-warning" href="http://www.mao10.com/article-index-single-id-66.html" style="background-color:#ff4a00; color:#fff;"><i class="glyphicon glyphicon-download"></i> 查看详情</a>
		</div>
