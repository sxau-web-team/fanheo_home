...
<body class="page-header-fixed">
	...
	<?php mc_template_part('Admin_sidebar'); ?>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							添加店铺 <small>今日任务：统计在售商户商品的库存</small>
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo U('Admin/Store/index');?>">店铺管理</a>
				...
				<form role="form" method="post" class="form-horizontal" action="<?php echo U('Admin/Store/publish_local'); ?>">
				...
				<div class="control-group">
					...
					<div class="control-group">
						...
						<label class="control-label">* 店铺签名：</label>
							...
							<div class="controls">
								...
								<input type="text" value="" class="m-wrap medium" name="public"/>
					...
					<div class="control-group">
						...
						<label class="control-label">* 店长：</label>
							...
							<div class="controls">
								...
								<input type="text" value="" class="m-wrap medium" name="header"/>
					...
					<div class="control-group">
						...
						<label class="control-label">* 店铺缩略图上传：</label>
	...
	<script>
		...
		<script type="text/javascript">
			...
			document.getElementById('brand').className = 'start active '; 
			
		</script>
		
		<script type="text/javascript">

			document.getElementById('addbrand').className = 'active '; 
