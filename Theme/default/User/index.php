				...
				<li class="list-group-item" id="mc-page-<?php echo $val['id']; ?>">
					<div class="row">
						<div class="col-sm-6 col-md-7 col-lg-9">
							<div class="media">
								...
								<a class="pull-left" href="<?php echo U('user/index/index?id='.$author); ?>">
									<img width="40" class="img-circle media-object" src="<?php echo mc_user_avatar($author); ?>" alt="<?php echo mc_user_display_name($author); ?>">
								</a>
						...
						<div class="col-sm-6 col-md-5 col-lg-3 text-right">
							<?php 
								if($type=='pro') :
								$type_name = '<span class="btn btn-sm btn-warning">商品</span>';
								elseif($type=='group') :
								$type_name = '<span class="btn btn-sm btn-danger">群组</span>';
								elseif($type=='group_pending') :
								$type_name = '<span class="btn btn-sm btn-danger">群组-待审核</span>';
								elseif($type=='baobei') :
								$type_name = '<span class="btn btn-sm btn-info">宝贝</span>';
								elseif($type=='baobei_pending') :
								$type_name = '<span class="btn btn-sm btn-info">宝贝-待审核</span>';
								else :
								$type_name = '<span class="btn btn-sm btn-success">主题</span>';
								endif;
								echo $type_name;
							?>
						</div>
