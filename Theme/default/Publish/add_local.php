<?php mc_template_part('header'); ?>
	...
	<div class="container">
		<div class="row">
			<form role="form" method="post" action="<?php echo U('home/perform/publish_local'); ?>">
			<div class="col-sm-9">
				...
				<div class="form-group">
					...
					<input name="public" type="text" class="form-control" placeholder="">
				</div>
				<div class="form-group">
					<label>
						店长
					</label>
					<input name="header" type="text" class="form-control" placeholder="">
				</div>
				<div class="form-group">
					<label>
						联系方式
				...
				<div class="form-group">
					...
					<input name="cook" type="text" class="form-control" placeholder="">
				</div>
				<div class="form-group">
					<label>
						店铺介绍
